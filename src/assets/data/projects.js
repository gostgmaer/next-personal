...
export const projectArray = [
  {
      ...
      "inspiration": "Electronic music producers and DJ's artistic expression is limited due to the standardization of hardware interfaces to music software (often referred to as controllers). Currently controller designs are meant to give the best general usage for as many users as possible, but as all artists express the art differently, they should be able choose their hardware interface to improve",
      "dates": {
          "start": 1435348689413,
          "current": true
      },
      ...
      "technologies": [
          {
              ...
              "link": "http://www.autodesk.com/products/inventor/overview",
              "icon": {
                  "url": "http://www.3cengineers.com/media/k2/items/cache/69bc9c3e85c501b0a6208cc7a55abbf9_Generic.jpg"
              }
          },
          {
              "name": "AngularJS",
      ...
      "takeaways": [
          "Hardware manufacturing requires imense capital to scale"
      ]
  },
  {
      "dates": {
      ...
      "pictures": [
          {
              "caption": "The medications list shows when there is a conflict between different medicines. It is common for patients to not remember or be able to provide their prescriptions when entering the emergency room. ",
              "image": {
                  "caption": "The medications list shows when there is a conflict between different medicines. It is common for patients to not remember or be able to provide their prescriptions when entering the emergency room. ",
      ...
      "inspiration": "Thousands of patients die a year in the emergency room when they are given something that negativley interacts with a medecine they are already taking.",
      "technologies": [
          {
              "name": "jQuery Mobile",
  ...
  {
      "inspiration": "After interviewing small buisnesses it became apparent that it is near impossible for a small buisness to leverage its own data without a dedicated data scientest of some kind.",
      "intro": "Escollate is a cross-platform mobile application that allows small business owners to solve complex financial problems by combining the power of real-time data with the wisdom of a collaborative community. This project aims to provide an open source and simple method for businesses to track, understand, and learn from their data. By marrying a simple, yet powerful user experience with a social network of informed supporters, Escollate gives small business owners \"Strength in Numbers.\"",
      "name": "Escollate",
      "importance": 2,
      ...
      "pictures": [
          ...
          {
              "caption": "This is a screenshot of the dashboard that the user is shown when they enter the app. The numbers on this dashboard allow the buisness to compare their numbers directly with other buisnesses like them.",
              "image": {
                  "url": "https://s3.amazonaws.com/prue-cdn/portfolio/Escollate/HoldingCheck.png"
              }
          },
          {
              "caption": "Graphs provide a visual explination of company data, but if the user still has a question, they can click to create a new question. The new question automatically includes the graph and other relevant data when being created to help questions to get answered more effectivley.",
              "image": {
                  "url": "https://s3.amazonaws.com/prue-cdn/portfolio/Escollate/Dash-Graphs.png"
              }
          },
          {
              "caption": "This is a screenshot of a specific question after the user has opened it.",
              "image": {
  ...
  {
      "intro": "I was hired by <a href='http://wacoproducts.com'>WACO Products</a> to transition their engineering systems from 2D drafting to 3D modeling. Though 2D CAD is a major improvement of hand drafting and has already saved WACO countless hours, it does not allow for easy stress analysis and design automation.",
      "inspiration": "Designing a customzied liquid control gate, one of WACO Product's top sellers, required between 6-8 hours of engineering time. Large orders easily stall the workflow because WACO had only a few engineers and even fewer software license seats.",
      "solution": "My experience with 3D modeling lead me to design a system that would incorporate parametric design to allow for model parameters/dimensions to be modified programatically.",
      "dates": {
          "start": 1435348689413,
          "current": false
      },
      ...
      "learned": "Networked parametric modeling can bring scalability to engineering systems.",
      "description": "While working at Waco Products I created a system that automates the engineering process of their liquid control gate product line. The system, which is still in place, uses information entered into a graphical interface to solve for the placement of all hardware, material, and supports.  Waco Products was my first professional interaction with the combination of software and hardware aspects of engineering. Before this system was implemented, engineering for each liquid control gate would take 6-9 hours. This improvement in efficiency continues to save WACO thousands on engineering costs for each project. The customization is controlled by a user interface where dimensions as well as options for the operator, bolt type, and seal type can be entered. The system then outputs 3D models which are used to automatically generate stress test information as well as engineering drawings for the completely customized product. ",
      "importance": 4,
      "intro2": "While working at Waco Products I created a system that automates the engineering process of their liquid control gate product line. The system, which is still in place, uses information entered into a graphical interface to solve for the placement of all hardware, material, and supports. ",
      "links": [
          {
      ...
      "pictures": [
          {
              "caption": "The graphical user interface (on the left) allows users to create a new gate design by entering options/dimensions. The Gate Designer automatically creates a rendering (on the right) of the 3D modeled gate after creation.",
              "image": {
                  "url": "https://s3.amazonaws.com/prue-cdn/portfolio/GateDesigner/GateGUI.png"
              }
          },
          {
              "caption": "The design of liquid control gates requires a large amount of engineering calculation that had to be automated through relationship algorithms which my team and I crafted from scratch based on the calumniation of our whole engineering department's experience with gate engineering.",
              "image": {
                  "url": "https://s3.amazonaws.com/prue-cdn/portfolio/GateDesigner/GateGUI.png"
              }
          }
  ...
  },
  {
      ...
      "intro": "HeartHub provides a standardized platform for wireless devices within hospitals so that medical device companies can easily communicate their data to the hospital.",
      "description": "The HeartHub application was designed and built during the April 10, 2014 MIT Hacking Medicine hackathon. The goal of HeartHub is to provide medical device developers with an easy method for sharing their device's data directly with hospitals. I functioned as the lead cross platform developer for this project, and along with my team presented HeartHub to a panel of judges.",
      "importance": 5,
      "links": [
          {
      ...
      "inspiration": "Sensors are becoming ever more popular, especially when it comes to healthcare. Startups and Major companies are building new devices faster than hospital staff can even make use of them, mostly due to the lack of standardization. As a developer of a hospital device/sensor you must build your own home base and handle complicated data formatting and communications, which makes providing insights to healthcare staff very difficult.",
      "solution": "Hearthub consists of both Hardware, which is optional, and an API, which can either run on a hearthub home base or a seperate server. This system provides data collected by devices within the hospital in a unified fashion for quick decision making by hospital staff. Hardware/Sensor developers can use the hearthub client API within their device to simplifiy interacting with and storing data related to healthcare.",
      "team": [
          {
              "name": "Mel van Londen",
              "url": "https://github.com/mvanlonden",
      ...
      "learned": "Another barrier between healthcare and data analytics is extremely stringent regulation related to healthcare data. Hospitals like storing everything within their own internal system, which means allowing Hearthub Server to be installed on hospital servers is imperative."
  },
  {
      "dates": {
          "current": true,
      ...
      "inspiration": "Setting up a development environment should not require advanced computer knowledge.",
    ...
    "frontendTechnologies": [
      {
        ...
        "technologies": [
          {
            "name": "JavaScript",
            "description": "A versatile scripting language used for building interactive web applications.",
            "icon": "FaJsSquare" // React Icons component name for the JavaScript icon
          },
          {
            "name": "HTML",
            "description": "HyperText Markup Language used for structuring web content.",
          ...
          },
          {
            "name": "TypeScript",
          icon:"FaTsSquare",
            "description": "A statically typed superset of JavaScript that helps catch errors at compile-time and provides better tooling for large-scale applications."
          },
          {
            "name": "SASS",
            "extensions": ["scss", "sass"],
            icon:"FaSass",
            "description": "An extension of CSS that adds features like variables, nesting, and mixins."
          },
        ]
      },
      {
      ...
      },
      {
        ...
        "technologies": [
          {
            "name": "Bootstrap",
            "description": "A front-end framework for designing responsive and attractive web pages.",
    ...
    ], "backendTechnologies": [
        {
          ...
          "technologies": [
            {
              "name": "Node.js",
              "description": "A runtime environment that allows you to run JavaScript on the server-side.",
              "icon": "FaNodeJs"
            },
            {
              "name": "Python",
              "description": "A versatile and widely-used programming language for server-side development.",
              "icon": "FaPython"
            },
            {
              "name": "Ruby",
              "description": "A dynamic, object-oriented programming language for web development.",
              "icon": "FaGem"
            }
          ]
        },
        {
          ...
          "technologies": [
            ...
            {
              "name": "Ruby on Rails",
              "description": "A web application framework for Ruby that follows the Model-View-Controller (MVC) pattern.",
              "icon": "FaGem"
            }
          ]
        },
        {
          ...
          "technologies": [
            {
              "name": "MongoDB",
              "description": "A NoSQL database that stores data in JSON-like documents with dynamic schemas.",
              "icon": "FaDatabase"
            },
            {
              "name": "MySQL",
