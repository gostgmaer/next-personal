export const projects = {
  basilar: {
    ...
    dates: { start: 1435348689413, current: true },
    ...
    technologies: [
      ...
      },
      {
        ...
        icon: { url: "http://amartam.com/images/nodejs2.png" },
      },
    ],
    pictures: [
      {
  ...
  dyml: {
    ...
    technologies: [
      { name: "jQuery Mobile", link: "https://jquerymobile.com/" },
    ],
    takeaways: [
  ...
  escollate: {
    ...
    technologies: [
      ...
      },
      {
        ...
        icon: { url: "http://ionicframework.com/img/ionic-logo-blog.png" },
      },
    ],
    pictures: [
      {
  ...
  "gate-designer": {
    ...
    dates: { start: 1435348689413, current: false },
    technologies: [
      {
        name: "Autodesk Inventor",
...
export const projectArray = Object.values(projects)