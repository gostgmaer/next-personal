...
const LeftContent = () => {
  return (
    <div className="topcontent  flex flex-col justify-between items-center w-full bg-[#dbdbdb] text-white">
      <div className="name-image">
        <div className="name text-center py-10  bg-[#442fb9]">
      ...
      <ContactInformation />
      <div className="bottom-curve overflow-hidden ">  <Education />
      <Referance/>
