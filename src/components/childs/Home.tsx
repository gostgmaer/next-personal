...
const Home = () => {
  return (
    <div id="home" className="flex w-full flex-col gap-32 justify-between min-h-[calc(100vh-80px)]">
    <div className="flex justify-center mt-32 items-center gap-4 flex-col ">
